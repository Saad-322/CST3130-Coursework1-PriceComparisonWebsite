...
describe('Database', () => {
    ...
    //Mocha test for getByPostcode method in database module.
    describe('#get Rooms by postcode', () => {
        it('should return rooms by postcode (NW1 - NW11)', (done) => {
            ...
            response.send = (result) => {
                ...
                //check that all vales in the array have the correct post code
                for (let i = 0; i < resObj.length; i++) {
                    expect(resObj[i].postcode).to.equal("NW10")
                }
            ...
            var offset = 0;
            var numItems = 20;
            var postcode = "NW10"//could be any post code betwee NW1 and NW11
...
describe('Web Service', () => {
    ...
    //Test of GET request sent to /rooms/* to check no.of rooms for each page is equal to 20
        ...
        it('should get 20 rooms for the page', (done) => {
            ...
            chai.request(server)
                ...
                .end((err, response) => {
                    ...
                    //Check that response array contains 20 entries for rooms as expected
    ...
    //Test of GET request sent to /rooms/* with incorrect postcode
